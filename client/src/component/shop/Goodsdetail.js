...
function Goodsdetail(props) {
  ...
  function addCart() {
    console.log("this is findgoods.id", findgoods.id);
    //data=상품 id
    let userId = JSON.parse(loginToken).userId;
    let data = {
      userId,
      productId: findgoods.id,
    };
    axios({
      method: "POST",
      url: `${SERVER}/cart/add`,
