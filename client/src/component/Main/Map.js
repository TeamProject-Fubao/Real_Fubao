    ...
    <MapContainer>
      <div style={{ display: "flex" }}>
        ...
        <div className="descriptionDiv">
          ...
          <div className="description">
            판다월드 사전 예약 : 100% 사전예약제(레니찬스)
          </div>
          <div className="description">
            레니찬스 스마트줄서기 예약오픈시간 : 10:00
          </div>
          <div className="description">판다월드 운영시간 : 10:20 ~ 17:00</div>
          <div className="description">
            <a
              href="https://www.everland.com/web/everland/how/traffic/how_traffic_info04.html"
              target="_blank"
            >
              에버렌드 교통정보 홈페이지
            </a>
